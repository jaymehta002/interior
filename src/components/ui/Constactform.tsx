            ...
            <form className=' flex flex-col gap-4' onSubmit={handleSubmit(onSubmit)}>
                ...
                >
                    <textarea
                        ...
                        placeholder=""
                        className="peer text-black dark:text-white pl-2 h-[16rem]  leading-normal appearance-none resize-none box-border text-base w-full text-inherit block text-left border border-solid bg-white dark:bg-zinc-800 rounded-[10px] m-0 p-0 outline-0 focus-visible:outline-0 focus-visible:border-teal-500 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#71717a2e] dark:focus-visible:ring-[#14b8a61a]"
                    />
                    <label
